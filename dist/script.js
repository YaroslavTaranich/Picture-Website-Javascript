...
/* harmony import */ var _modules_scroling__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/scroling */ "./src/js/modules/scroling.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_scroling__WEBPACK_IMPORTED_MODULE_11__["default"])('.pageup');
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calsFunc = function calsFunc() {
...
var filter = function filter() {
  ...
  var btnGrandmather = menu.querySelector('.grandmother');
  ...
  btnGrandmather.addEventListener('click', function () {
    typeFilter();
  });
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      console.log(api);
      Object(_servises_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        console.log(res);
  ...
  function bindModal(triggerSelectr, modalSelector, closeSelector) {
    ...
    function showWindows() {
      windows.forEach(function (item) {
        item.style.display = "none";
        item.classList.add('animated', 'lightSpeedIn');
      });
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_servises_requests__WEBPACK_IMPORTED_MODULE_3__["getResourse"])('http://localhost:3000/styles').then(function (res) {
...
var sliders = function sliders(slidersSelector, dir, prev, next) {
  var slideIndex = 1,
      paused = false;
  var items = document.querySelectorAll(slidersSelector);
